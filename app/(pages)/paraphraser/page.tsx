    ...
    return (
        <div className="container">
            ...
            <div className="container-main">
                <h1>Paraphraser</h1>
                <p>A paraphraser rewrites text in different words while preserving the original meaning.</p>
                        ...
                        {prompt.length > 5 ? (
                            <>
                                {content.process ? (
                                    ...
                                    <div className='button' onClick={run} style={content.blocked ? { background: "#dc2626" } : { background: "var(--zinc-100)" }}>Rephrase</div>
                                )}
                            </>
                        ) : (
                            <div className='button-disabled'>Rephrase</div>
                        )}
