    ...
    const run = async () => {
        ...
        Run({
            ...
            if (x.status !== 200) {
                ...
                if (x.output.includes("invalid-prompt")) {
                    setPrompt("")

                    setContent({
                        output: "The provided prompt doesn't seem to be an image prompt.",
                        process: false,
                        blocked: true
                    })
                } else {
    ...
    return (
        <div className="container">
            ...
            <div className="container-main">
                ...
                <p>An image prompt enhancer improves image-based prompts by adding context or guidance.</p>
