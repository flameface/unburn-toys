    ...
    return (
        <div className="container">
            ...
            <div className="container-main">
                <h1>Summarizer</h1>
                <p>A summarizer condenses text into shorter summaries while preserving key information.</p>
                        ...
                        {prompt.length > 5 ? (
                            <>
                                {content.process ? (
                                    ...
                                    <div className='button' onClick={run} style={content.blocked ? { background: "#dc2626" } : { background: "var(--zinc-100)" }}>Summarize</div>
                                )}
                            </>
                        ) : (
                            <div className='button-disabled'>Summarize</div>
                        )}
